<!--
<p align="center">
  <img src="https://github.com/cthoyt/sssom-pydantic/raw/main/docs/source/logo.png" height="150">
</p>
-->
...
<p align="center">
    <a href="https://github.com/cthoyt/sssom-pydantic/actions/workflows/tests.yml">
        <img alt="Tests" src="https://github.com/cthoyt/sssom-pydantic/actions/workflows/tests.yml/badge.svg" /></a>
    <a href="https://pypi.org/project/sssom_pydantic">
        <img alt="PyPI" src="https://img.shields.io/pypi/v/sssom_pydantic" /></a>
    <a href="https://pypi.org/project/sssom_pydantic">
    ...
    <a href="https://github.com/cthoyt/sssom-pydantic/blob/main/.github/CODE_OF_CONDUCT.md">
...
6. Standardizes against Bioregistry preferred CURIE prefixes and RDF URI prefixes

## 🚀 Installation

The most recent release can be installed from
[PyPI](https://pypi.org/project/sssom_pydantic/) with uv:

```console
$ uv pip install sssom_pydantic
```

or with pip:

```console
$ python3 -m pip install sssom_pydantic
```

The most recent code and data can be installed directly from GitHub with uv:

```console
$ uv pip install git+https://github.com/cthoyt/sssom-pydantic.git
```

or with pip:

```console
$ python3 -m pip install git+https://github.com/cthoyt/sssom-pydantic.git
```
...
appreciated. See
[CONTRIBUTING.md](https://github.com/cthoyt/sssom-pydantic/blob/master/.github/CONTRIBUTING.md)
...
```console
$ git clone git+https://github.com/cthoyt/sssom-pydantic.git
$ cd sssom-pydantic
$ uv pip install -e .
```
...
[GitHub Action](https://github.com/cthoyt/sssom-pydantic/actions?query=workflow%3ATests).
...
https://zenodo.org/account/settings/github/repository/cthoyt/sssom-pydantic to
...
1. Uses [bump-my-version](https://github.com/callowayproject/bump-my-version) to
   ...
   `src/sssom_pydantic/version.py`, and
...
1. Navigate to https://github.com/cthoyt/sssom-pydantic/releases/new to draft a
   new release

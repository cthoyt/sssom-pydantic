...
class RequiredSemanticMapping(SQLModel):
    ...
    predicate_modifier: PredicateModifier | None = Field(None, sa_type=String)
...
class SemanticMapping(CoreSemanticMapping, SemanticallyStandardizable, SQLModel, table=True):

...
from sssom_pydantic.api import get_mapping_hash, mapping_to_sexpr_str
...
class TestSexpr(unittest.TestCase):
    ...
    def test_smoke(self) -> None:
        ...
        for example in EXAMPLES:
            with self.subTest(example=example.description):
                s = get_mapping_hash(example.semantic_mapping, TEST_CONVERTER)
    ...
    def test_explicit(self) -> None:
        ...
        for mapping, sexpr, digest in CASES:
            ...
            self.assertEqual(digest, get_mapping_hash(mapping, converter=CONVERTER))

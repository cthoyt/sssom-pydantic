...
bridge_cases: list[tuple[Axiom | None, SemanticMapping]] = [
    # exact match + no NOT
    (
...
class TestEndToEnd(unittest.TestCase):
    ...
    def test_simple(self) -> None:
        """Test end-to-end."""
        write_owl(
            [self.m], self.path, converter=self.converter, metadata=TEST_MAPPING_SET, mode="bridge"
        )
        self.assertEqual(
            dedent(f"""\
    ...
    def test_declarations_with_annotations(self) -> None:
        ...
        self.assertEqual(
            ...
            AnnotationAssertion(rdfs:label mesh:C000089 "ammeline")
            AnnotationAssertion(rdfs:label chebi:28646 "ammeline")
            EquivalentClasses(Annotation(sssom:mapping_justification semapv:ManualMappingCuration) Annotation(pav:authoredBy orcid:0000-0003-4423-4370) Annotation(sssom:confidence "0.8"^^xsd:double) mesh:C000089 chebi:28646)
    ...
    def test_declarations_no_names_no_authors(self) -> None:
        """Test end-to-end."""
        m = SemanticMapping(
            subject=R1.without_name(),
            predicate=v.exact_match,
            object=R2.without_name(),
            justification=v.unspecified_matching_process,
        )
    ...
    def test_declarations_no_names_no_authors_annotations(self) -> None:
        """Test end-to-end."""
        m = SemanticMapping(
            subject=R1.without_name(),
            predicate=v.exact_match,
        ...
        self.assertEqual(
            ...
            Declaration(Class(mesh:C000089))
            Declaration(Class(chebi:28646))
            EquivalentClasses(Annotation(sssom:mapping_justification semapv:UnspecifiedMatching) Annotation(pav:authoredBy orcid:0000-0003-4423-4370) mesh:C000089 chebi:28646)
            Declaration(Class(<http://purl.obolibrary.org/obo/NCBITaxon_9606>))
            AnnotationAssertion(rdfs:label <http://purl.obolibrary.org/obo/NCBITaxon_9606> "human")
            Declaration(NamedIndividual(orcid:0000-0003-4423-4370))
            ClassAssertion(<http://purl.obolibrary.org/obo/NCBITaxon_9606> orcid:0000-0003-4423-4370)
    ...
    def test_declarations_no_names(self) -> None:
        """Test end-to-end."""
        m = SemanticMapping(
            subject=R1.without_name(),
            predicate=v.exact_match,
    ...
    def test_bad_mode(self) -> None:
        ...
        with self.assertRaises(ValueError):
            list(get_axioms([self.m], converter=self.converter, mode="nope"))  # type:ignore[arg-type]
